...
```html
<iframe id="pm-events" src="https://pennmediated.github.io/events/" title="Events — Penn MEDIATED" scrolling="no" loading="lazy" style="width:100%;height:2300px;border:0;display:block"></iframe><script>(function(){var f=document.getElementById('pm-events');window.addEventListener('message',function(e){if(e.source!==f.contentWindow)return;var d=e.data||{},h=d.frameHeight||(d.type==='partners-page-resize'?d.height:0);if(h)f.style.height=h+'px';});})();</script>
```
